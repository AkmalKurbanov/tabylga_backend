    ...
    return [
        ...
        'components' => [
            ...
            'shared' => [
                ...
                'messages_success'  => ['title' => 'Успешно'            , 'description' => 'Сообщение об успешной отправке формы', 'default' => 'Сиздин формаңыз ийгиликтүү тапшырылды!'],
        ...
        'settings' => [
            ...
            'global_messages_success' => ['label' => 'Глобальное сообщение об успешной отправки формы', 'comment' => '(Этот параметр может быть переопределен из компонента)', 'default' => 'Сиздин формаңыз ийгиликтүү тапшырылды'],
